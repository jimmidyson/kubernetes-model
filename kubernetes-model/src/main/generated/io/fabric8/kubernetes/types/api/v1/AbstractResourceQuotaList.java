 ...
 */
@Value.Immutable
abstract class AbstractResourceQuotaList {

  @JsonUnwrapped
  @Value.Derived
  public io.fabric8.kubernetes.types.api.unversioned.TypeMeta getTypeMeta() {
    return io.fabric8.kubernetes.types.api.unversioned.TypeMeta.of("ResourceQuotaList", "v1");
  }
   ...
   */
  @JsonProperty("items")
  public abstract java.util.List<io.fabric8.kubernetes.types.api.v1.ResourceQuota> getItems();
