...
abstract class AbstractHorizontalPodAutoscaler implements io.fabric8.kubernetes.types.api.HasMetadata {
  ...
  public io.fabric8.kubernetes.types.api.unversioned.TypeMeta getTypeMeta() {
    return io.fabric8.kubernetes.types.api.unversioned.TypeMeta.of("HorizontalPodAutoscaler", "extensions/v1beta1");
  }
   ...
   */
  @JsonProperty("spec")
  public abstract io.fabric8.kubernetes.types.apis.extensions.v1beta1.HorizontalPodAutoscalerSpec getSpec();

  /*
   * current information about the autoscaler.
   */
  @JsonProperty("status")
  public abstract io.fabric8.kubernetes.types.apis.extensions.v1beta1.HorizontalPodAutoscalerStatus getStatus();
