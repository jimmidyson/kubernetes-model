...
abstract class AbstractJob implements io.fabric8.kubernetes.types.api.HasMetadata {
  ...
  public io.fabric8.kubernetes.types.api.unversioned.TypeMeta getTypeMeta() {
    return io.fabric8.kubernetes.types.api.unversioned.TypeMeta.of("Job", "batch/v1");
  }
   ...
   */
  @JsonProperty("spec")
  public abstract io.fabric8.kubernetes.types.apis.batch.v1.JobSpec getSpec();
   ...
   */
  @JsonProperty("status")
  public abstract io.fabric8.kubernetes.types.apis.batch.v1.JobStatus getStatus();
