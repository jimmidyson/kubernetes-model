 ...
 */
@Value.Immutable
abstract class AbstractJobList {

  @JsonUnwrapped
  @Value.Derived
  public io.fabric8.kubernetes.types.api.unversioned.TypeMeta getTypeMeta() {
    return io.fabric8.kubernetes.types.api.unversioned.TypeMeta.of("JobList", "batch/v2alpha1");
  }
   ...
   */
  @JsonProperty("items")
  public abstract java.util.List<io.fabric8.kubernetes.types.apis.batch.v2alpha1.Job> getItems();
