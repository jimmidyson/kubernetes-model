 ...
 */
@Value.Immutable
abstract class AbstractPolicy implements io.fabric8.kubernetes.types.api.HasMetadata {

  @JsonUnwrapped
  @Value.Derived
  public io.fabric8.kubernetes.types.api.unversioned.TypeMeta getTypeMeta() {
    return io.fabric8.kubernetes.types.api.unversioned.TypeMeta.of("Policy", "v1");
  }
   ...
   */
  @JsonProperty("roles")
  public abstract java.util.List<io.fabric8.openshift.types.authorization.v1.NamedRole> getRoles();
